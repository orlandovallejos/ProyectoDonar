        ...
        // video player
            ...
            $scope.videoChange = function($event,videoID) {
                ...
                if(!$this.hasClass(active_class)) {
                    var iframe_embed = '<iframe height="150" width="300" data-uk-cover src="https://www.youtube.com/v/' + videoID + '?rel=0" frameborder="0" allowfullscreen style="max-height:100%"></iframe>';
